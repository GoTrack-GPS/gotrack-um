# 1.6. Routes
- Routes is the vehicle route statistics in the state: Running, as well as travel time, start-end location, distance, speed of the vehicle in a period of time.
- To view the Routes Report do the following:
  - Go to **<span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/dynamic.svg )Report > <span class= "icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/chart-line.svg) Report > Routes**.
 
  <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-english/reports/route-in.png)

###  Search
- Step 1 : You can search by the following criteria:
  <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-english/reports/route-search.png)
...
* When searching results, click **Download** to export data
  ...
  <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-english/reports/route-export.png)
