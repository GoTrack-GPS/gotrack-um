...
- Để xem Báo cáo Điểm dừng thực hiện như sau : 
  - Vào **<span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/dynamic.svg )Báo cáo > <span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/chart-line.svg)  Báo cáo > Điểm dừng**.
 
  <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/stop-point.png)
...
- Có thể tìm kiếm theo các tiêu chí sau :
  ...
  - Nhấn **Tìm kiếm** để xem Điểm dừng.
