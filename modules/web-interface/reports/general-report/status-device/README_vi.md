# 1.8. Trạng thái thiết bị
- Trạng thái thiết bị là thống kê trạng thái, địa chỉ hiện tại và các thông tin khác của từng thiết bị có trong tài khoản đang đăng nhập/đang chọn.
- Khi xe đang dừng/Đang dừng mở khóa thì sẽ chỉ hiển thị trạng thái Dừng trong bảng này.
- Để xem Báo cáo  Trạng thái thiết bị thực hiện như sau : 
  - Vào **<span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/dynamic.svg )Báo cáo > <span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/chart-line.svg)  Báo cáo > Trạng thái thiết bị**.
...
- Có thể tìm kiếm theo các tiêu chí sau :
  ...
  - Nhấn **Tìm kiếm** để xem Trạng thái thiết bị.
