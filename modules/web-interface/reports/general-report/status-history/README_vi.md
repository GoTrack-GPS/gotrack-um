# 1.9. Lịch sử trạng thái
- Lịch sử trạng thái là thống kê trạng thái Hành trình/Động cơ/ Điều hòa và các thông tin khác của từng lộ trình,  thiết bị có trong tài khoản đang đăng nhập/đang chọn.
