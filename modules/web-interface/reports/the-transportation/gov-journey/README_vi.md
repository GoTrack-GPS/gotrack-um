...
* Hiện ra màn hình **TT73-Hành trình xe chạy** như hình dưới đây :
    ...
    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-journey-in.jpg)
...
* Bước 2 : Nhấn **Tìm kiếm** .
    ...
    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-journey-search.jpg)
