# 4.7. TT73-Tổng hợp theo lái xe


Nếu người dùng muốn xem **Báo cáo TT73-Tổng hợp theo lái xe** :  
* Vào **<span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/dynamic.svg )Báo cáo > <span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/icons8-police-uniform.svg)  Bộ giao thông vận tải > TT73-Tổng hợp theo lái xe**.

* Hiện ra màn hình **TT73-Tổng hợp theo lái xe** như hình dưới đây :

    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-summary-by-driver.png)
...
* Bước 1 : Tìm kiếm theo các tiêu chí sau :
    ...
    * **Lái xe** :   Nhấn chọn 1 hoặc nhiều thiết bị muốn xem báo cáo.
