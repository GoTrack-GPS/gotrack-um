...
# 4.8. TT09-Thời gian lái xe trong ngày


Nếu người dùng muốn xem **Báo cáo TT73-Tổng hợp lái xe trong ngày** :  
* Vào **<span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/dynamic.svg )Báo cáo > <span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/icons8-police-uniform.svg)  Bộ giao thông vận tải > TT09-Thời gian lái xe trong ngày**.

* Hiện ra màn hình **TT09-Thời gian lái xe trong ngày** như hình dưới đây :

    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-driving-on-day.png)
...
* Bước 1 : Tìm kiếm theo các tiêu chí sau :
    ...
    * **Biển số** :   Nhấn chọn 1 hoặc nhiều thiết bị muốn xem báo cáo.
    * **Quá 4h** : Tích chọn nếu muốn xem khoảng thời gian xe chạy hơn 10h.
...
* Bước 2 : Nhấn **Tìm kiếm** .
    ...
    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-driving-on-day-search.png)
