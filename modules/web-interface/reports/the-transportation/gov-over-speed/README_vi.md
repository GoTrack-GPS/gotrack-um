...
* Hiện ra màn hình **TT73-Quá tốc độ giới hạn** như hình dưới đây :
    ...
    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-over-speed.png)
...
* Bước 2 : Nhấn **Tìm kiếm** .
    ...
    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-over-speed-search.png))
