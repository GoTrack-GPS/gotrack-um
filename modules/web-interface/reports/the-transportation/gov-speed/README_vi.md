...
* Hiện ra màn hình **TT73-Tốc độ từng giây** như hình dưới đây :
    ...
    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-speed.png)
...
* Bước 2 : Nhấn **Tìm kiếm**.
    ...
    <span style="display:block;text-align:left">![Interface Web](/docs/assets/images/web-interface/reports/gov-speed-search.png)
