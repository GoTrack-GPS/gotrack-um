...
* **Cài đặt IP máy chủ camera**
    ...
    <span class="icon-left6">![Manage device ](/docs/assets/images/web-interface/livestream/ip-camera.jpg)
...
* Bên bộ phận kĩ thuật sẽ cấu hình thiết bị trên https://camera.gotrack365.com 
* Sau đó, bạn vào https://gps.gotrack.vn để đăng nhập.
* Vào mục **Quản lý > Thiết bị**.
...
* Click vào **<span class="icon-left svg-filter-serch">![Ok](/docs/assets/images/web-interface/icon/SVG/icons8-edit.svg)Sửa > Camera > <span class="icon-left svg-filter-tick">![Ok](/docs/assets/images/web-interface/icon/SVG/plus.svg) Thêm camera**
    ...
    - **Host** : Địa chỉ IP hoặc tên miền truy cập server camera : https://camera.gotrack365.com 
...
* Cài đặt máy chủ trung tâm kết nối
    ...
    <span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/center-sv.png)
