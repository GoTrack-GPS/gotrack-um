...
<table>
    ...
    <tr >
        ...
        <td>Up, down, left and right arrow keys 
The left and right arrow keys have both playback video
Fast forward and fast rewind function,
</td> 
    </tr>
</table>

#### 1.3 System operation and settings
##### 1.3.1. Boot preview
...
<table>
    <tr >
        <td align="center"><span class="icon-left12"> <img src="/docs/assets/images/integrated-devices/smc/sm400/boot-preview-1.png">
        <td align="center"> <span class="icon-left12"><img src="/docs/assets/images/integrated-devices/smc/sm400/boot-preview-2.png">  
        </td>
    </tr >
</table>
...
&emsp;&ensp;	<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/login.png)
...
##### 1.3.3. System operation and settings
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/main-menu.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/terminal.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/time.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/user.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/power-setting.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/volumn.png)

**Camera settings: set the video direction and picture effects**

&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/camera.png)

② **Video settings: basic settings, main stream settings, sub stream settings, timing settings, storage management, OSD settings**

&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/record.png)

**Basic setting: basic recording parameter setting**

&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/general.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/main-rec.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/sub-rec.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/time-rec.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/disk-manage.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/osd-set.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/record-search.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/search-result.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/net.png)


**Local setting: local IP setting**

&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/lan.png)

    Set local IP address
**4G setting: 3G/4G dialing parameter setting**

&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/3g-4g.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/wifi.png)
...
<table>
    <tr >
        <td align="center"><span class="icon-left12"> <img src="/docs/assets/images/integrated-devices/smc/sm400/center-sv.png">
        <td align="center"> <span class="icon-left12"><img src="/docs/assets/images/integrated-devices/smc/sm400/bb-sv.png">  
        </td>
    </tr >
</table>
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/ftp.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/alarm.png)

I/O alarm setting: IO line required：


&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/io.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/speed.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/move-detect.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/temp.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/voltage.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/serial.png)

**Serial port settings: 1 RS485, 1 RS232 serial port.**

&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/serial-port.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/ptz.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/tools.png)

**Format: format the video disk**

&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/format.png)
...
* Important: Formatting will erase the data on the SD card disk数据；

**Parameter management:**

&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/config.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/log-search.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/disk-speed.png)
...
&emsp;&ensp;<span class="icon-left12">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/ruler.png)
...
Positioning: there are four states: no module, no positioning, no antenna connection or short circuit. Please refer to 4.3 for positioning problems
Network: four states, no module, no dialing, dialing in, dialing successfully. See 4.5 for platform issues

### 2. Wiring diagram

#### 2.1. Wiring diagram of SD video recorder

&emsp;&ensp;<span class="icon-left6">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/diagram-sd.png)

#### 2.2.	Wiring diagram of HDD video recorder

&emsp;&ensp;<span class="icon-left6">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/diagram-hdd.png)
...
<table>
    <tr >
        <td align="center"><span class="icon-left12"> <img src="/docs/assets/images/integrated-devices/smc/sm400/power-cable.png">
        <td align="center"> <span class="icon-left12"><img src="/docs/assets/images/integrated-devices/smc/sm400/car-battery.png">  
        </td>
    </tr >
</table>
...
&emsp;&ensp;<span class="icon-left09">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/terminal-sv-.png)

##### 2.3.3. IO serial port use 

* The device has 4 alarm inputs and 2 alarm output interfaces. The alarm input detection is all level detection, which can be connected to various vehicle driving states, such as brake, steering, vehicle switch, and alarm button, as shown in Figure 4-2. When the brake plate is stepped on, MDVR can 

&emsp;&ensp;<span class="icon-left09">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/+12V.png)

&emsp;&ensp;<span class="icon-left09">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/24V.png)

Detect the high level, otherwise the low level, the alarm output is all level output, and the drive capacity is 200mA. If you connect a larger power device, you must connect a relay. As shown in Figure 4-3:
...
&emsp;&ensp;<span class="icon-left09">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/method1.png)

&emsp;&ensp;<span class="icon-left09">![Interface Web](/docs/assets/images/integrated-devices/smc/sm400/method2.png)
