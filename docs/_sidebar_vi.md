...
- [**Giao diện web**](vi/modules/web-interface/ "Giải pháp giám sát GPS chuyên nghiệp")
    ...
    - [Thiết bị GPS](vi/modules/web-interface/devices/)
      - [Thêm thiết bị](vi/modules/web-interface/users/)
      - [Chuyển thiết bị](vi/modules/web-interface/users/)
      - [Kích hoạt](vi/modules/web-interface/users/)
      - [gia hạn](vi/modules/web-interface/users/)
      - [Gửi lệnh](vi/modules/web-interface/users/)
    - [Giám sát trên bản đồ](vi/modules/web-interface/tracking/)
      - [Khoanh vùng](vi/modules/web-interface/users/)
      - [Thông báo](vi/modules/web-interface/tracking/)
